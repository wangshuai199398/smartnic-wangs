...
- [ ] 3.1 Implement Doorbell address decoder that maps BAR0 offsets to QP SQ, QP RQ, and CQ arm operations.
- [ ] 3.2 Implement per-function Doorbell aperture checks for PF and VF ownership.
- [ ] 3.3 Implement SQ Doorbell payload parsing and QP producer index update.
