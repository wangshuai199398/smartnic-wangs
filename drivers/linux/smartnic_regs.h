...
#define SMARTNIC_INTR_STATUS           0x0200
#define SMARTNIC_INTR_ENABLE           0x0204
#define SMARTNIC_INTR_ACK              0x0208
#define SMARTNIC_INTR_MASK             0x020c

#define SMARTNIC_INTR_MAILBOX_DONE     0x00000001u
#define SMARTNIC_INTR_ADMIN_EVENT      0x00000002u
#define SMARTNIC_INTR_CQ_EVENT         0x00000004u
#define SMARTNIC_INTR_FATAL_ERROR      0x00000008u
#define SMARTNIC_INTR_ALL_EVENTS       (SMARTNIC_INTR_MAILBOX_DONE | \
					 SMARTNIC_INTR_ADMIN_EVENT | \
					 SMARTNIC_INTR_CQ_EVENT | \
					 SMARTNIC_INTR_FATAL_ERROR)

#define SMARTNIC_MIN_IRQ_VECTORS       1
#define SMARTNIC_MAX_IRQ_VECTORS       4
#define SMARTNIC_IRQ_ADMIN_VECTOR      0
#define SMARTNIC_IRQ_EVENT_VECTOR      1
