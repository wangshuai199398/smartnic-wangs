...
.PHONY: all lint verilator cocotb pcie-test doorbell-test qp-test cq-test mr-test dma-test driver userspace regression coverage clean
...
cocotb:
	@echo "[cocotb] 运行 Cocotb PCIe 控制面、Doorbell、QP、CQ、MR 和 DMA 单元测试入口。"
