...
- `make dma-test` 运行 DMA descriptor dispatcher 测试，覆盖 SQ Send/RDMA Write host read、RQ Recv host write、RDMA Read response host write、CQE write、WQE/SGE fetch、unsupported opcode、zero length、output backpressure 和 fixed-priority arbitration。
